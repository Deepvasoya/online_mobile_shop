...
$q8 = "SELECT * FROM `returnorder` WHERE `oid` = '$ordersid'";
        ...
        <div class="row">
            ...
            <div class="col-8" style="min-height: 900px;">
                <div class="container my-5">
                    <a href="_returnorders.php" class="btn btn-primary btn-sm my-auto active" role="button">BACK</a>
                </div>
                            ...
                            <div class="login-form" id="order">
                                <form action="" method="post">
                                    ...
                                    while ($row8 = mysqli_fetch_array($r8)) {
                                        $itemame = $row8['itemname'];
                                        $reason = $row8['reason'];
                                        $comment = $row8['comment'];
                                        $img = "SELECT * FROM `tbl_product` WHERE `prod_name` = '$itemame'";
                                        $rimg = mysqli_query($con, $img);
                                        while ($rimg3 = mysqli_fetch_array($rimg)) {
                                            $img = $rimg3['image'];
                                            $pid = $rimg3['prod_id'];
                                    ?>
                                        ...
                                        <table class="table">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><input type="hidden" id="hdns_<?php echo $row2['prod_id'] ?>" name="hdns_<?php echo $row2['prod_id'] ?>" value="<?php echo $row2['ordersid'] ?>" />
                                                        <input type="hidden" name="prod_id_<?php echo $row2['prod_id'] ?>" id="prod_id_<?php echo $row2['prod_id'] ?>" value="<?php echo $row2['prod_id'] ?>"><select class="col-3" name="status_<?php echo $pid; ?>" id="status_<?php echo $pid ?>" value="<?php if (isset($_POST['status'])) {
                                                                                                                                                                                                                                                                                                                echo $_POST['status'];
                                                                                                                                                                                                                                                                                                            } ?>">
                                                    ...
                                                    <td>
                                                        <input type="button" onclick="update_status(<?php echo $pid;; ?>);" value="Submit" class="btn btn-primary text-light bg-primary check_out" name="submit" id="submit" style="width:60px" />
                                                    </td>
